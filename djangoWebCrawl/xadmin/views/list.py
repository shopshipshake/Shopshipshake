...
class ListAdminView(ModelAdminView):
    ...
    def get_context(self):
        ...
        new_context = {
            ...
            'has_redirect_permission': self.has_redirect_permission(),
            'redirect_url': self.model_redirect_url('redirect'),
    ...
    def result_item(self, obj, field_name, row):
        ...
        elif self.redirect and (item.field_name == 'offer_url'):
            item_red_uri = self.model_redirect_url(item.field.value_to_string(obj))
            if item_red_uri:
